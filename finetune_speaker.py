...
def run(rank, n_gpus, hps):
  ...
  # load existing model
  _, _, _, iterationG = utils.load_checkpoint("./pretrained_models/G_trilingual.pth", net_g, None)
  _, _, _, iterationD = utils.load_checkpoint("./pretrained_models/D_trilingual.pth", net_d, None)
